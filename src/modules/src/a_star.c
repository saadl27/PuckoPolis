...
void a_star_init(Graph* graph) {
    ...
    a_star_add_edge(graph, NODE_01,  NODE_05,  WEIGHT_01_05, SOUTH, NORTH_WEST);
    a_star_add_edge(graph, NODE_01,  NODE_03,  WEIGHT_01_03, EAST, NORTH);
    a_star_add_edge(graph, NODE_01,  NODE_02,  WEIGHT_01_02, SOUTH, NORTH);
    a_star_add_edge(graph, NODE_02,  NODE_06,  WEIGHT_02_06, WEST, NORTH_EAST);
    a_star_add_edge(graph, NODE_02,  NODE_04,  WEIGHT_02_04, SOUTH, WEST);
    a_star_add_edge(graph, NODE_04,  NODE_10, WEIGHT_04_10, EAST, EAST);
    a_star_add_edge(graph, NODE_04,  NODE_09,  WEIGHT_04_09, SOUTH, NORTH);
    a_star_add_edge(graph, NODE_05,  NODE_06,  WEIGHT_05_06, NORTH_EAST, NORTH_WEST);
    a_star_add_edge(graph, NODE_05,  NODE_07,  WEIGHT_05_07, SOUTH_WEST, NORTH);
    a_star_add_edge(graph, NODE_07,  NODE_08,  WEIGHT_07_08, SOUTH, SOUTH_WEST);
    a_star_add_edge(graph, NODE_06,  NODE_08,  WEIGHT_06_08, SOUTH_EAST, NORTH_EAST);
    a_star_add_edge(graph, NODE_07,  NODE_13, WEIGHT_07_13, WEST, WEST);
    a_star_add_edge(graph, NODE_08,  NODE_09,  WEIGHT_08_09, SOUTH_EAST, WEST);
    a_star_add_edge(graph, NODE_11, NODE_13, WEIGHT_11_13, WEST, NORTH);
    a_star_add_edge(graph, NODE_13, NODE_14, WEIGHT_13_14, SOUTH, WEST);
    a_star_add_edge(graph, NODE_14, NODE_15, WEIGHT_14_15, EAST, WEST);
    a_star_add_edge(graph, NODE_09,  NODE_10, WEIGHT_09_10, EAST, WEST);
    a_star_add_edge(graph, NODE_10, NODE_12, WEIGHT_10_12, SOUTH, WEST);
    a_star_add_edge(graph, NODE_03,  NODE_12, WEIGHT_03_12, SOUTH, NORTH);
    a_star_add_edge(graph, NODE_12, NODE_15, WEIGHT_12_15, SOUTH, EAST);
    a_star_add_edge(graph, NODE_03,  NODE_15, WEIGHT_03_15, EAST, SOUTH);
    a_star_add_edge(graph, NODE_11, NODE_14, WEIGHT_11_14, SOUTH, NORTH);
    a_star_add_edge(graph, NODE_09,  NODE_11, WEIGHT_09_11, SOUTH, NORTH);
}
