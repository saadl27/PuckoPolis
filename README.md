...
- First read up to the end of the GPIO configuration this documentation page
...
- First read through all this documentation page
  - click 👉 [here](https://github.com/EPFL-MICRO-315/TPs-Student/wiki/STM32-Presenting-the-STM32#timer-configuration)
